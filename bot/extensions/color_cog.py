...
from discord.ext.commands import Cog, hybrid_group, HybridCommandError, CommandInvokeError, Context
...
class ColorCog(Cog, name="Color", description="Collection of commands to bring color in your life."):
    ...
    async def display_color(self, ctx: Context, color: Union[Tuple[int, int, int], str]) -> None:
