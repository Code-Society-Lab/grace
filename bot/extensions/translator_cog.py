...
class TranslatorCog(Cog, name="Translator", description="Translate sentances in any languages."):
    ...
    def language_code(language):
        ...
        languages_available = googletrans.LANGCODES
        for code in languages_available:
            if language == languages_available[code]:
                return True
        return False

    @hybrid_command(name='translator', \
                    help='Translate a sentence/word in any languages. Enter /language_code to see your language code', \
